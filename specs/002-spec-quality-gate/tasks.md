...
- [ ] T707 [cheap] Auditor-liveness runner coupling for the spec-quality auditor
      ...
      dispatch row + frontmatter (`skills/auditor-liveness/SKILL.md`) to dispatch
      ...
      spec-quality. Completes US1.AC4's liveness loop that T702 deferred; graded against
      the issue's done-when criteria (the T605 maintenance pattern), not a new AC.
      Discovered while working #180 → #182. (US1)
