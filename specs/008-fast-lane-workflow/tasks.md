...
- [ ] T1301 [strong] Deterministic fast-lane scope checker — explicit inputs (base ref,
      ...
      documented, neutrality scan green (US1)
...
- [ ] T1302 [strong] Runtime-neutral fast-lane workflow doc (`workflow/fast-task.md`) —
      ...
      workflow or owner-approved reclassification; blocked by T1301 (US2)
- [ ] T1303 [cheap] Active-adapter fast-lane binding + PR-body evidence — binding points
