...
| `workflow/reviewers/maker-eval-corpus.md` | KEEP | Frozen instrument manifest for maker-eval — corpus, lifecycle metadata, rubrics, pinned-judge spec, scoring schema, calibration pointer. Portable; verbatim. |
