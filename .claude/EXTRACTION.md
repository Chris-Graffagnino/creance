...
| `hooks/maker-eval-emit.test.sh` | KEEP | Behavioral tests for the maker-eval emitter — fingerprint independence, record/packet fencing, silent-write, partial-run completeness, and the T807 snapshot cases (cadence fixture, byte-identical-on-write-failure, two-sided trajectory-incomplete marking). Verbatim. |
